...
From the literature review in chapter \ref{chap:relatedWork} we presented table \ref{table:comparisonRelatedWork} which compares related applications and relevant features from them. Using the comparison we drafted additional requirements which aim to include features which the related applications do not.       
