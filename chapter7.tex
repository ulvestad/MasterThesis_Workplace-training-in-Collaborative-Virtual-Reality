...
As this phase's artefact should include a distributable file for the end users we determined that we must consider the usability of it. Considering objectives such as intuitiveness, feedback, instructions and ease of use. 


\subsubsection{Networking}
It was also found that the existing application with all its serialised data and networked tasks was put through some sort of benchmarking with the limit of connected users, ensuring a stable experience across any HMD or laptop.    
