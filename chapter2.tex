...
\begin{table}[!ht]
      ...
      \caption{Important specifications for head-mounted displays to consider.}
       ...
       \vspace{0.2cm}
        ...
        \\
        \vspace{0.2cm}
        Field of view (FOV) & How much the user can see of the virtual world. The higher the field of view the more the user can see without rotating the head.
        \\
        \bottomrule
