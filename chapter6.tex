...
Due to the Covid-19 pandemic and restriction by the Norwegian government as part of their action to prevent spread of the disease it became clear that getting proper data collection to answer Secondary RQ2 \ref{RQ} was not feasible. We did plan to run test for data collection with both peers and mentors. As discussed with our supervisors we decided to add a research question which shifts focus to remote collaboration as a career guidence tool. However, we consider the RQ2 as part of furture work, see Section \ref{} for more.  More about a Kompentanse Norge og presentasjon over Zoom + Microsoft form etc. 
